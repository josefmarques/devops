...
from main import bccrypt_context, ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES, SECRET_KEY
...
def autenticar_usuario(email, senha, session):
    ...
    if not usuario:
        return False
    elif not bccrypt_context.verify(senha, usuario.senha):
        return False
    return usuario
...
# login -> email e senha -> token JWT (Json Wev Token) dhkdhfkdhfkdhlkdhfkdhf
